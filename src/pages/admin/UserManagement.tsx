              ...
              <table className="w-full text-left min-w-[500px]">
                ...
                <tbody className="divide-y divide-slate-100">
                  {filtered.map((u, i) => {
                    ...
                    const Icon = cfg.icon;
                    return (
                      <tr key={u.id} className="hover:bg-slate-50 transition-colors animate-fade-up" style={{ animationDelay: `${i * 20}ms` }}>
                        ...
                        <td className="px-4 py-3">
                          <span className={`inline-flex items-center gap-1.5 text-[11px] font-bold px-2.5 py-0.5 rounded-md border ${cfg.bg} ${cfg.color}`}>
                        ...
                        <td className="px-4 py-3">
                          <div className="relative">
                            ...
                            {openMenu === u.id && (
                              <div className="absolute right-0 top-9 z-20 w-40 bg-white border border-slate-200 rounded-xl shadow-xl overflow-hidden animate-fade-up">
                                <button
                                  type="button"
